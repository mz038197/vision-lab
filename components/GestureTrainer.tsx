    ...
    <div className="w-full bg-gray-900 border border-gray-700 rounded-xl overflow-hidden shadow-2xl flex flex-col h-full max-h-[calc(100vh-180px)]">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {trainingLogs.length > 0 && (
          <div className="bg-black rounded-lg p-3 font-mono text-xs text-green-400 max-h-24 overflow-y-auto border border-gray-800">
            <div className="flex justify-between border-b border-gray-800 pb-1 mb-1 text-gray-500">
              <span>Epoch</span>
              <span>Loss</span>
            </div>
